...
/**
 * Gives the laserCannon protection and makes it harder for the Aliens to kill lasercannon.
 * @author Kennon
 *Has hits to know the current state of the bunker. 
 *BUNKER_DIMENSION_WIDTH,BUNKER_DIMENSION_HEIGHT, sets the size of the bunker. 
 */
public class Bunker extends ScreenObject {
 ...
 /**
  * Creates a bunker with a certain location, size and image.
  * Has integer to keep up with relative damage. 
  * @param h is the relative damage
  * @param l is the location
  * @param s is the point
