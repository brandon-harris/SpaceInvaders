...
public class Screen extends JPanel implements KeyListener {
    ...
    private class EnemyShotTimerListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            while (shooterAlien.location.getX() < -10 && keepLooping) {
    ...
    public Screen() {
        ...
        alienObjects = new ArrayList<>();
        bunkerObjects = new ArrayList<>();
    ...
    public void collideObjects() {
        ...
        for (Shot shots : playerShots) {
            if (shots.collide(mysteryShipPic)) {
